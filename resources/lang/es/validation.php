...
Search
Sign in or Sign up
 Watch 13  Star 91  Fork 58 Laraveles/lang-spanish
 Code  Issues 0  Pull requests 1  Projects 0 Insights 
Branch: master Find file Copy pathlang-spanish/es/validation.php
0f1c9bf  23 days ago
@hosmelq hosmelq add ipv4 and ipv6 rules
7 contributors @IsraelOrtuno @sandyfigueroa @luvejo @xoxefdp @JavierCabezas @hosmelq @glisandro
RawBlameHistory     
124 lines (115 sloc)  7.3 KB
<?php
return [
    /*
    |--------------------------------------------------------------------------
